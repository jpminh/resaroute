L'agence de voyages Resanet a décidé de lancer le projet resaroute, ce projet à pour but de créer une application unique d'aspiration d'informations sur les sites de transports publics tel celui de la SNCF.
